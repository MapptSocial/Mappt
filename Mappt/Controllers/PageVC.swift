...
class PageVC: PagerController, PagerDelegate, PagerDataSource, ButtonDelegate {
    
    @IBOutlet weak var titleName: OutlineLabel!

    var searchString = ""
    var controller1 = SearchPeopleVC()
    var controller2 = SearchPlacesVC()
    ...
    override func viewDidLoad() {
        ...
        self.controller1 = storyboard.instantiateViewController(withIdentifier: "SearchPeopleVC") as! SearchPeopleVC
        
        self.controller2 = storyboard.instantiateViewController(withIdentifier: "SearchPlacesVC") as! SearchPlacesVC
        
        self.setupPager(tabNames: ["People", "Places"],
